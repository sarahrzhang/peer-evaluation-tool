class EvaluationsController < ApplicationController
  ...
  def create
    ...
    #TODO fix me BAD
    #@evaluation.project_id = Project.first.id
    @evaluation.group_id = get_current_group.id
  ...
  private
    ...
    def evaluation_params
      params.require(:evaluation).permit(:project_description, :student_id, :leadership_score, :communication_score, :contribution_score, :quality_score, :skills_score, :comment)
    end
end
